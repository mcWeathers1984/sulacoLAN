...
*	061425-160301-MDT-mikew-v0.0.0.2: Use the history command (or cat the .bash_history file) | grep "install" to get
all the packages installed with apt or dnf. This should help make sure we didnt forget anything.
